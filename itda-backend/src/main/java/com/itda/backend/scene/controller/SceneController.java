...
public class SceneController {
    ...
    @Operation(
            summary = "씬 생성",
            description = "프로젝트에 새 씬을 생성합니다."
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "201",
                    description = "생성 성공",
                    content = @Content(schema = @Schema(implementation = SceneCreateResponse.class))
            ),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "400",
    ...
    @Operation(
            summary = "씬 목록 조회",
            description = "프로젝트의 씬 목록을 조회합니다."
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
                    description = "조회 성공",
                    content = @Content(array = @ArraySchema(schema = @Schema(implementation = SceneSummaryResponse.class)))
            ),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "401",
                    description = "인증 필요"
    ...
    @Operation(
            summary = "씬 상세 조회",
            description = "씬의 상세 정보를 조회합니다."
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
                    description = "조회 성공",
                    content = @Content(schema = @Schema(implementation = SceneDetailResponse.class))
            ),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "401",
                    description = "인증 필요"
    ...
    @Operation(
            summary = "씬 수정",
            description = "씬 제목/설명 및 연결된 객체 정보를 수정합니다."
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "씬 순서 변경",
            description = "프로젝트 내 씬 순서를 변경합니다."
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "씬 내보내기 파일 다운로드",
            description = "병합된 씬 파일을 다운로드합니다. (실제 Content-Type은 서버에서 설정됩니다.)"
    )
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
